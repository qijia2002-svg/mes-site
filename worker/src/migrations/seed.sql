...
> 本章用一个示例带你走一遍：一张工单从「客户下单」到「关单结算」会经历什么。读完你能指着一张工单说出它现在在哪一步、为什么卡住、下一步该干什么。

## 先认识一张示例工单

打开系统，找一张生产工单，比如 **WO-20260801-02**（示例数据）。它在练习样例库中的示例记录是：
